/*
 * jfreesteel-lib-gui: Serbian eID Viewer GUI Library (GNU LGPLv3)
...
package net.devbase.jfreesteel.lib.gui;
...
public class GUIPanel extends JPanel
{
	...
	private static final ResourceBundle bundle = ResourceBundle.getBundle("net.devbase.jfreesteel.lib.gui.jfreesteel-lib-gui"); //$NON-NLS-1$
    ...
    public GUIPanel()
    {
        ...
        URL throbberURL = GUIPanel.class.getResource("/net/devbase/jfreesteel/lib/gui/throbber.gif");
